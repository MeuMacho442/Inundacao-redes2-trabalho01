...
public class Janela {
    ...
    ********************************************************************************************/
    public void editarTexto(int contador) {
          ...
          configurarPainel.editarTexto(contador);
    ...
    * Retorno: vazio  
    ********************************************************************************************/
    public void adicionarTextoPainelDireito(int peso, double x, double y) {
           configurarPainelDireito.adicionarTexto(String.valueOf(peso),x,y);
